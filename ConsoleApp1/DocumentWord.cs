...
namespace TestOpenXml
{
    ...
    {
        public List<TestRecipient> TestListRecipients { get; set; }
        ...
        private void GenerateMainDocumentPart1Content(MainDocumentPart mainDocumentPart1)
        {
            ...
            foreach (var recipient in TestListRecipients)
            {
                var flag = true;
            ...
            //var paragraph1 = new Paragraph() { RsidParagraphAddition = "00072315", RsidRunAdditionDefault = "00E6355D" };

            //var run1 = new Run() { RsidRunProperties = "0016562C" };
            //var text1 = new Text();
            //text1.Text = "1-";

            //run1.Append(text1);

            //var run2 = new Run() { RsidRunAddition = "0016562C" };
            //var text2 = new Text();
            //text2.Text = "й получатель";
            ...
            //var paragraph2 = new Paragraph() { RsidParagraphAddition = "00E6355D", RsidParagraphProperties = "0016562C", RsidRunAdditionDefault = "00E6355D" };

            //var paragraphProperties1 = new ParagraphProperties();
            //var spacingBetweenLines1 = new SpacingBetweenLines() { After = "0" };
            //var indentation1 = new Indentation() { FirstLine = "708" };
            ...
            //var paragraph3 = new Paragraph() { RsidParagraphMarkRevision = "00E6355D", RsidParagraphAddition = "00E6355D", RsidParagraphProperties = "0016562C", RsidRunAdditionDefault = "00E6355D" };

            //var paragraphProperties2 = new ParagraphProperties();
            //var indentation2 = new Indentation() { FirstLine = "708" };

            //paragraphProperties2.Append(indentation2);

            //var run6 = new Run();
            //var text6 = new Text() { Space = SpaceProcessingModeValues.Preserve };
            //text6.Text = "Почтовый адрес: ";

            //run6.Append(text6);

            //var run7 = new Run() { RsidRunAddition = "0016562C" };
            //var tabChar2 = new TabChar();

            //run7.Append(tabChar2);

            //var hyperlink1 = new Hyperlink() { History = true, Id = "rId5" };

            //var run8 = new Run() { RsidRunProperties = "0016562C" };

            //var runProperties1 = new RunProperties();
            //var runStyle1 = new RunStyle() { Val = "a4" };
            ...
            //run8.Append(runProperties1);
            //run8.Append(text7);

            //var run9 = new Run() { RsidRunProperties = "00AE4F3B" };

            //var runProperties2 = new RunProperties();
            //var runStyle2 = new RunStyle() { Val = "a4" };

            //runProperties2.Append(runStyle2);
            //var text8 = new Text();
            //text8.Text = "1";

            //run9.Append(runProperties2);
            //run9.Append(text8);

            //var run10 = new Run() { RsidRunProperties = "0016562C" };

            //var runProperties3 = new RunProperties();
            //var runStyle3 = new RunStyle() { Val = "a4" };
            ...
            //var run11 = new Run() { RsidRunProperties = "0016562C" };

            //var runProperties4 = new RunProperties();
            //var runStyle4 = new RunStyle() { Val = "a4" };
            ...
            //var run12 = new Run() { RsidRunProperties = "0016562C" };

            //var runProperties5 = new RunProperties();
            //var runStyle5 = new RunStyle() { Val = "a4" };
            ...
            //var run13 = new Run() { RsidRunProperties = "0016562C" };

            //var runProperties6 = new RunProperties();
            //var runStyle6 = new RunStyle() { Val = "a4" };
            //var languages3 = new Languages() { Val = "en-US" };

            //runProperties6.Append(runStyle6);
            ...
            //hyperlink1.Append(proofError1);
            //hyperlink1.Append(run13);
            //hyperlink1.Append(proofError2);

            //paragraph3.Append(paragraphProperties2);
            //paragraph3.Append(run6);
            //paragraph3.Append(run7);
            //paragraph3.Append(hyperlink1);

            //var paragraph4 = new Paragraph() { RsidParagraphAddition = "00E6355D", RsidParagraphProperties = "00E6355D", RsidRunAdditionDefault = "00E6355D" };
            ...
            //var run15 = new Run() { RsidRunProperties = "0016562C" };
            //var text14 = new Text();
            //text14.Text = "-";
            ...
            //var run16 = new Run();
            //var text15 = new Text() { Space = SpaceProcessingModeValues.Preserve };
            //text15.Text = "й ";

            //run16.Append(text15);

            //var run17 = new Run() { RsidRunAddition = "0016562C" };
            //var text16 = new Text();
            //text16.Text = "п";

            //run17.Append(text16);

            //var run18 = new Run() { RsidRunAddition = "0016562C" };
            //var text17 = new Text();
            //text17.Text = "олучатель";
            ...
            //var paragraph5 = new Paragraph() { RsidParagraphAddition = "00E6355D", RsidParagraphProperties = "0016562C", RsidRunAdditionDefault = "00E6355D" };

            //var paragraphProperties3 = new ParagraphProperties();
            //var spacingBetweenLines2 = new SpacingBetweenLines() { After = "0" };
            //var indentation3 = new Indentation() { FirstLine = "708" };

            //paragraphProperties3.Append(spacingBetweenLines2);
            //paragraphProperties3.Append(indentation3);

            //var run20 = new Run();
            //var text19 = new Text() { Space = SpaceProcessingModeValues.Preserve };
            //text19.Text = "Имя получателя: ";
            ...
            //var text20 = new Text();
            //text20.Text = "Получатель2";

            //run21.Append(tabChar3);
            //run21.Append(text20);
            ...
            //var paragraph6 = new Paragraph() { RsidParagraphMarkRevision = "00E6355D", RsidParagraphAddition = "00E6355D", RsidParagraphProperties = "0016562C", RsidRunAdditionDefault = "00E6355D" };

            //var paragraphProperties4 = new ParagraphProperties();
            //var indentation4 = new Indentation() { FirstLine = "708" };

            //paragraphProperties4.Append(indentation4);

            //var run22 = new Run();
            //var text21 = new Text() { Space = SpaceProcessingModeValues.Preserve };
            //text21.Text = "Почтовый адрес: ";

            //run22.Append(text21);

            //var run23 = new Run() { RsidRunAddition = "0016562C" };
            //var tabChar4 = new TabChar();

            //run23.Append(tabChar4);

            //var hyperlink2 = new Hyperlink() { History = true, Id = "rId6" };

            //var run24 = new Run() { RsidRunProperties = "0016562C" };

            //var runProperties7 = new RunProperties();
            //var runStyle7 = new RunStyle() { Val = "a4" };
            //var languages4 = new Languages() { Val = "en-US" };

            //runProperties7.Append(runStyle7);
            //runProperties7.Append(languages4);
            //var text22 = new Text();
            //text22.Text = "address";

            //run24.Append(runProperties7);
            //run24.Append(text22);

            //var run25 = new Run() { RsidRunProperties = "00AE4F3B" };

            //var runProperties8 = new RunProperties();
            //var runStyle8 = new RunStyle() { Val = "a4" };

            //runProperties8.Append(runStyle8);
            //var text23 = new Text();
            //text23.Text = "2";
            ...
            //var run26 = new Run() { RsidRunProperties = "0016562C" };

            //var runProperties9 = new RunProperties();
            //var runStyle9 = new RunStyle() { Val = "a4" };

            //runProperties9.Append(runStyle9);
            //var text24 = new Text();
            //text24.Text = "@";

            //run26.Append(runProperties9);
            //run26.Append(text24);

            //var run27 = new Run() { RsidRunProperties = "0016562C" };

            //var runProperties10 = new RunProperties();
            //var runStyle10 = new RunStyle() { Val = "a4" };
            //var languages5 = new Languages() { Val = "en-US" };

            //runProperties10.Append(runStyle10);
            //runProperties10.Append(languages5);
            //var text25 = new Text();
            //text25.Text = "server";

            //run27.Append(runProperties10);
            //run27.Append(text25);

            //var run28 = new Run() { RsidRunProperties = "0016562C" };

            //var runProperties11 = new RunProperties();
            //var runStyle11 = new RunStyle() { Val = "a4" };

            //runProperties11.Append(runStyle11);
            //var text26 = new Text();
            //text26.Text = ".";

            //run28.Append(runProperties11);
            //run28.Append(text26);
            //var proofError3 = new ProofError() { Type = ProofingErrorValues.SpellStart };

            //var run29 = new Run() { RsidRunProperties = "0016562C" };

            //var runProperties12 = new RunProperties();
            //var runStyle12 = new RunStyle() { Val = "a4" };
            //var languages6 = new Languages() { Val = "en-US" };

            //runProperties12.Append(runStyle12);
            //runProperties12.Append(languages6);
            //var text27 = new Text();
            //text27.Text = "ru";

            //run29.Append(runProperties12);
            //run29.Append(text27);
            //var proofError4 = new ProofError() { Type = ProofingErrorValues.SpellEnd };

            //hyperlink2.Append(run24);
            //hyperlink2.Append(run25);
            //hyperlink2.Append(run26);
            //hyperlink2.Append(run27);
            //hyperlink2.Append(run28);
            //hyperlink2.Append(proofError3);
            //hyperlink2.Append(run29);
            //hyperlink2.Append(proofError4);

            //paragraph6.Append(paragraphProperties4);
            //paragraph6.Append(run22);
            //paragraph6.Append(run23);
            //paragraph6.Append(hyperlink2);

            //var sectionProperties1 = new SectionProperties() { RsidRPr = "00E6355D", RsidR = "00E6355D" };
